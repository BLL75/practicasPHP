...
foreach($provincias as $codigo => $nombre) {  
  $elementosJSON[]['provincia'] = array("codigo"=>$codigo,"nombre"=>$nombre);
}

echo json_encode(['provincias'=>$elementosJSON]);

// Para validar si el JSON esta correcto lo podemos validar WWW.JSONLint.com
